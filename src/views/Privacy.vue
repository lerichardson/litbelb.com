<template>
  <div class="iub_content legal_pp">
    <div class="iub_header">
      <h1>Privacy Policy of <strong>litbelb.com</strong></h1>
      ...
      <p>
        ...
        <a href="#brazil_info" target="_self"
          >a section dedicated to Brazilian Users and their privacy rights</a
        >.
      </p>
      <p>
    ...
    <div class="one_line_col">
      ...
      <p>Levi Richardson</p>
      <p><strong>Owner contact email:</strong> litbelb1@outlook.com</p>
    </div>
    ...
    <div class="one_line_col">
      ...
      <p>
        ...
        itself or through third parties, there are: first name; email address;
        Usage Data; Tracker.
      </p>
    ...
    <div class="one_line_col">
      ...
      <p>
        ...
        the following: Contacting the User, Content commenting, Traffic
        optimization and distribution and Hosting and backend infrastructure.
      </p>
      ...
      <ul class="for_boxes">
        <li>
          <div class="box_primary box_10 expand">
            <h3 class="expand-click w_icon_24 policyicon_purpose_8226482">
              Contacting the User
            </h3>
        ...
        <li>
          <div class="box_primary box_10 expand">
            <h3 class="expand-click w_icon_24 policyicon_purpose_8226487">
              Content commenting
            </h3>
            <div class="expand-content">
              <p>
                ...
                Personal Data provided by the User, it may be used to send
                ...
                where the comment service is installed, even when Users do not
                use the content commenting service.
              </p>

              <h4>Muut (Muut, Inc.)</h4>
              <div class="wrap">
                <p>
                  Muut is a content commenting and forum service provided by
                  Muut, Inc.
                </p>
              </div>
              ...
              <p>
                ...
                <a
                  href="https://muut.com/terms/privacy-policy.html"
                  target="_blank"
        ...
        <li>
          <div class="box_primary box_10 expand">
            <h3 class="expand-click w_icon_24 policyicon_purpose_8226627">
        ...
        <li>
          <div class="box_primary box_10 expand">
            <h3 class="expand-click w_icon_24 policyicon_purpose_8226626">
              Traffic optimization and distribution
            </h3>
            <div class="expand-content">
              <p>
                This type of service allows this Application to distribute their
                content using servers located across different countries and to
                optimize their performance.<br />
                Which Personal Data are processed depends on the characteristics
                and the way these services are implemented. Their function is to
                filter communications between this Application and the User's
                browser.<br />
                ...
                may contain Personal Information of the User are transferred.
              </p>
              ...
              <div class="wrap">
                <p>
                  ...
                  provided by Cloudflare Inc.<br />
                  The way Cloudflare is integrated means that it filters all the
                  traffic through this Application, i.e., communication between
                  this Application and the User's browser, while also allowing
                  analytical data from this Application to be collected.
                </p>
              </div>

              <p>
                Personal Data processed: Tracker; various types of Data as
    ...
    <div class="one_line_col">
      ...
      <p>
        ...
        by the business running this Application and, if the case may be, its
      ...
      <p>
        ...
        we've collected, disclosed or sold and the purposes thereof.
        <strong
      ...
      <p>
        ...
        you: identifiers and internet information.
      </p>
      <p>
      ...
      <p>
        ...
        that work with us in connection with the Service or with the functioning
        of this Application and features thereof.
      </p>
      ...
      <p>
        ...
        will abide by your request.<br />Such requests can be made freely, at
        any time, without submitting any verifiable request, simply by following
      ...
      <p>
        ...
        to all the sales carried out by this Application, both online and
      ...
      <ul>
        <li>
          the categories and sources of the personal information that we collect
          about you, the purposes for which we use your information and with
      ...
      <p>
        ...
        and repair errors on this Application, to detect security incidents and
    ...
    <div class="one_line_col">
      ...
      <p>
        This part of the document integrates with and supplements the
        information contained in the rest of the privacy policy and is provided
        by the entity running this Application and, if the case may be, its
        parent, subsidiaries and affiliates (for the purposes of this section
        referred to collectively as “we”, “us”, “our”).<br />
        The provisions contained in this section apply to all Users who reside
        in Brazil, according to the "Lei Geral de Proteção de Dados" (Users are
        referred to below, simply as “you”, “your”, “yours”). For such Users,
        these provisions supersede any other possibly divergent or conflicting
        provisions contained in the privacy policy. <br />
        This part of the document uses the term “personal information“ as it is
        defined in the Lei Geral de Proteção de Dados (<strong>LGPD</strong>).
      </p>
      ...
      <h3>
        Your Brazilian privacy rights, how to file a request and our response to
        your requests
      </h3>
      ...
      <p>
        We will strive to promptly respond to your requests.<br />
      ...
      <p>
        ...
        information <strong> processing confirmation</strong> request, please
        make sure that you specify whether you’d like your personal information
        to be delivered in electronic or printed form. <br />
        ...
        fashion, or if you need a complete disclosure instead. <br />
      ...
      <p>
        ...
        <strong
          ...
          blocking</strong
        >
        request, we will make sure to immediately communicate your request to
        other parties with whom we have shared your personal information in
        order to enable such third parties to also comply with your request –
    ...
    <div class="iub_footer">
      <p>Latest update: April 15, 2021</p>

      <p>
        <a
          target="_top"
          href="/en/privacy-and-cookie-policy-generator"
          title="iubenda - Privacy Policy generator"
          >iubenda</a
        >
        hosts this content and only collects
        <a target="_top" href="//www.iubenda.com/privacy-policy/65675001"
      ...
      <a
        href="//www.iubenda.com/privacy-policy/92498930"
        title="Show the simplified Privacy Policy"
        class="show_comp_link iframe-preserve an-preserve"
        >Show the simplified Privacy Policy</a
      >
    </div>
  </div>
</template>
